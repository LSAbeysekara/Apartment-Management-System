    ...
    <div class="form-container">
        <div class="table-wrapper">
            <div class="header-container">
                ...
                <a href="new-request-electricity.php"><button class="new-request-button">
                    New Requests
...
$(document).ready(function () {
    ...
    $('#submit-all').click(function () {
        ...
        $.post('save_e_all_bills.php', { bills }, function (response) {
            Swal.fire({
                icon: 'success',
                title: 'Success',
                text: response.message
