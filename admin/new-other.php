    ...
    <div class="form-container">
        <div class="table-wrapper">
            <div class="header-container">
                <h2>Other Bills</h2>
                <a href="new-request-other.php"><button class="new-request-button">
                    New Requests

                    <?php
                    $sql = "SELECT COUNT(*) AS request_count FROM tbl_customer WHERE Other = 'request'";
...
$(document).ready(function () {
    ...
    $('#submit-all').click(function () {
        ...
        $.post('save_o_all_bills.php', { bills }, function (response) {
            Swal.fire({
                icon: 'success',
                title: 'Success',
                text: response.message
