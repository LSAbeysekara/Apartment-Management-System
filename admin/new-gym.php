    ...
    <div class="form-container">
        <div class="table-wrapper">
            <div class="header-container">
                <h2>Gym Bills</h2>
                <a href="new-request-gym.php"><button class="new-request-button">
                    New Requests
...
$(document).ready(function () {
    ...
    $('#submit-all').click(function () {
        ...
        $.post('save_gym_all_bills.php', { bills }, function (response) {
            Swal.fire({
                icon: 'success',
                title: 'Success',
                text: response.message
