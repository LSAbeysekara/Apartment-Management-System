    ...
    <div class="form-container">
        <div class="table-wrapper">
            <div class="header-container">
                <a href="new-water.php" class="back-link"><span class="material-symbols-outlined">arrow_back</span></a>
            </div>
...
<script>
    ...
    $(document).on('click', '.btn-save', function () {
        ...
        $.ajax({
            url: 'approve-request-water.php',  // PHP file that will handle the approval
            method: 'POST',
            data: { cus_id: cusId, bill_type: 'Water' },
            dataType: 'json',
    ...
    $('#submit-all').on('click', function () {
        if (confirm('Are you sure you want to approve all requests?')) {
            $.ajax({
                url: 'approve-request-water-all.php',  // PHP file that will handle the approval for all
                method: 'POST',
                dataType: 'json',
                success: function (response) {
                    alert(response.message);
    ...
    $(document).on('click', '.btn-cancel', function () {
        ...
        if (confirm('Are you sure you want to deny this request?')) {
            $.ajax({
                url: 'deny-request-water.php',  // PHP file that will handle the denial
                method: 'POST',
                data: { cus_id: cusId, bill_type: 'Water' },
                dataType: 'json',
                success: function (response) {
    ...
    function fetchNonJoinedAccounts() {
        $.ajax({
            url: 'fetch_e_non_bills_water.php',
            method: 'GET',
            dataType: 'json',
            success: function (data) {
    ...
    // Handle Add to Water button click
    $('#non-joined').on('click', '.btn-add', function () {
        const cusId = $(this).data('cus-id');
        const billType = 'Water'; // Define bill type here
