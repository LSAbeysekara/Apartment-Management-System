    ...
    <div class="form-container">
        <div class="table-wrapper">
            <div class="header-container">
                <h2>Telephone and Interned Bills</h2>
                <a href="new-request-phone.php"><button class="new-request-button">
                    New Requests
...
$(document).ready(function () {
    ...
    $('#submit-all').click(function () {
        ...
        $.post('save_t_all_bills.php', { bills }, function (response) {
            Swal.fire({
                icon: 'success',
                title: 'Success',
                text: response.message
